...
public class OfficeForCreationDtoValidatorTests
{
    private readonly OfficeForCreationDtoValidator _validator = new();
    ...
    {
        var dto = new OfficeForCreatingDto { City = city };
    ...
    {
        var dto = new OfficeForCreatingDto { Street = street };
    ...
    {
        var dto = new OfficeForCreatingDto { HouseNumber = houseNumber };
    ...
    {
        var dto = new OfficeForCreatingDto { OfficeNumber = officeNumber };
    ...
    {
        var dto = new OfficeForCreatingDto { RegistryPhoneNumber = phone };
